  ...
  <tbody>
    <tr>
      ...
      <td>
        <a
          className="nowrap"
          href="/api/switchboardv2-api/classes/VrfAccount#create"
        >
    ...
    <tr>
      ...
      <td>
        <a
          className="nowrap"
          href="/api/switchboardv2-api/classes/VrfAccount#prove"
        >
          <SiTypescript className="devicons__nowrap" /> Typescript
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a
          className="nowrap"
          href="/api/switchboardv2-api/classes/VrfAccount#verify"
        >
          <SiTypescript className="devicons__nowrap" /> Typescript
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a
          className="nowrap"
          href="/api/switchboardv2-api/classes/VrfAccount#requestrandomness"
        >
          <SiTypescript className="devicons__nowrap" /> Typescript
        </a>
        <br />
