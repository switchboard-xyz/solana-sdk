...
* [`sbv2 queue add crank [QUEUEKEY]`](#sbv2-queue-add-crank-queuekey)
...
USAGE
  $ sbv2 aggregator create copy [AGGREGATORSOURCE] --queueKey <value> [-v] [-s] [--mainnetBeta] [-u <value>] [--programId
    <value>] [-k <value>] [--force] [-a <value>] [--minOracles <value>] [--batchSize <value>] [--minJobs <value>]
...
FLAGS
  ...
  -f, --outputFile=<value>  output aggregator definition to a json file
  -k, --keypair=<value>     keypair that will pay for onchain transactions. defaults to new account authority if no
                            alternate authority provided
...
```
USAGE
  $ sbv2 queue add crank [QUEUEKEY] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k <value>] [-n
