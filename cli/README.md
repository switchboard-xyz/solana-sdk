...
> **Warning**
> This package has been deprecated in favor of @switchboard-xyz/cli
...
_See code: [dist/commands/print/index.ts](https://github.com/switchboard-xyz/switchboard-v2/blob/v0.2.27/dist/commands/print/index.ts)_
...
_See code: [dist/commands/sandbox.ts](https://github.com/switchboard-xyz/switchboard-v2/blob/v0.2.27/dist/commands/sandbox.ts)_
...
_See code: [dist/commands/test.ts](https://github.com/switchboard-xyz/switchboard-v2/blob/v0.2.27/dist/commands/test.ts)_
