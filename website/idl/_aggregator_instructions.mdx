  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a
          className="nowrap"
          href="/api/py/aggregator#aggregatorinitparams-objects"
        >
    ...
    <tr>
      ...
      <td>
        ...
        <a
          className="nowrap"
          href="/api/py/permission#permissioninitparams-objects"
        >
          <SiPython className="devicons__nowrap" /> Python
        </a>
        <br />
    ...
    <tr>
      ...
      <td>
        ...
        <a
          className="nowrap"
          href="/api/py/aggregator#aggregatoropenroundparams-objects"
        >
          <SiPython className="devicons__nowrap" /> Python
        </a>
        <br />
    ...
    <tr>
      ...
      <td>
        ...
        <a
          className="nowrap"
          href="/api/py/aggregator#aggregatorsethistorybufferparams-objects"
        >
          <SiPython className="devicons__nowrap" /> Python
        </a>
      </td>
