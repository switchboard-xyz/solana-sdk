...
_See code: [src/commands/aggregator/add/crank.ts](https://github.com/switchboard-xyz/switchboardv2-cli/blob/v0.1.6/src/commands/aggregator/add/crank.ts)_
...
_See code: [src/commands/aggregator/add/history.ts](https://github.com/switchboard-xyz/switchboardv2-cli/blob/v0.1.6/src/commands/aggregator/add/history.ts)_
